...
;; Early init for LSP
;;
;; NOTE Need to recompile lsp packages or this will break.  Nuke `lsp-mode' from
;;      the packages, with `package-delete' or from straight. Then, to rebuild
;;      all packages:
;;
;;      $ doom sync
...
(doom! :input
       ...
       window-select     ; ace-window or switch-window
       ...
       (org +pretty +gnuplot +dragndrop +roam +hugo) ; organize your plain life in plain text
