...
;; Receipe to be used by `treesit-install-language-grammar'. Run this command to
;; update language libraries, or:
;;
;;   (mapc #'treesit-install-language-grammar
;;     (mapcar #'car treesit-language-source-alist))
;;
;; ...to install all languages at one go.
...
(use-package! ellama
  ...
  ;; stock config example from ellama
  (require 'llm-ollama)
  ...
  :config
  ;; hide ellama context in header line in all buffers
  (ellama-context-header-line-global-mode +1)
  ;; hide ellama session id in header line in all buffers
